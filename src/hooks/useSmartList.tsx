...
const useSmartList = () => {
	const smartLists: SmartListAttributes[] = [
		{
	...
	const isAnSmartList = (_id: SmartListsIds) => {
		Object.values(SmartListsIds).includes(_id);

		return smartLists.find((l) => l._id == _id);
	};

	return { smartLists, isAnSmartList };
};

export default useSmartList;
